...
func (ac *AccountCreate) SetBank(s string) *AccountCreate {
	ac.mutation.SetBank(s)
	return ac
}

// SetBic sets the "bic" field.
func (ac *AccountCreate) SetBic(s string) *AccountCreate {
	ac.mutation.SetBic(s)
	return ac
}
...
func (ac *AccountCreate) check() error {
	...
	if _, ok := ac.mutation.Bank(); !ok {
		return &ValidationError{Name: "bank", err: errors.New(`ent: missing required field "Account.bank"`)}
	}
	if v, ok := ac.mutation.Bank(); ok {
	...
	if _, ok := ac.mutation.Bic(); !ok {
		return &ValidationError{Name: "bic", err: errors.New(`ent: missing required field "Account.bic"`)}
	}
	if v, ok := ac.mutation.Bic(); ok {
...
func (ac *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.Bank(); ok {
		_spec.SetField(account.FieldBank, field.TypeString, value)
		_node.Bank = value
	}
	if value, ok := ac.mutation.Bic(); ok {
