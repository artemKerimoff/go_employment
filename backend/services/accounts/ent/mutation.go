...
func (m *AccountMutation) SetBank(s string) {
	m.bank = &s
}

// Bank returns the value of the "bank" field in the mutation.
func (m *AccountMutation) Bank() (r string, exists bool) {
	v := m.bank
	if v == nil {
		return
	}
...
// OldBank returns the old "bank" field's value of the Account entity.
// If the Account object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AccountMutation) OldBank(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AccountMutation) ResetBank() {
	m.bank = nil
}

// SetBic sets the "bic" field.
func (m *AccountMutation) SetBic(s string) {
	m.bic = &s
}

// Bic returns the value of the "bic" field in the mutation.
func (m *AccountMutation) Bic() (r string, exists bool) {
	v := m.bic
	if v == nil {
		return
	}
...
// OldBic returns the old "bic" field's value of the Account entity.
// If the Account object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AccountMutation) OldBic(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBic is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldBic requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
...
func (m *AccountMutation) ResetBic() {
	m.bic = nil
}
...
func (m *AccountMutation) Fields() []string {
	...
	if m.bank != nil {
		fields = append(fields, account.FieldBank)
	}
	if m.bic != nil {
		fields = append(fields, account.FieldBic)
	}
	if m.created_at != nil {
...
func (m *AccountMutation) Field(name string) (ent.Value, bool) {
	...
	case account.FieldNumber:
		return m.Number()
	case account.FieldBank:
		return m.Bank()
	case account.FieldBic:
		return m.Bic()
