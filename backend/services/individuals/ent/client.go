...
import (
	...
	"github.com/example/micro/individuals/ent/migrate"
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.Individual.Intercept(interceptors...)
}
...
func (c *IndividualClient) UpdateOneID(id int64) *IndividualUpdateOne {
...
func (c *IndividualClient) DeleteOneID(id int64) *IndividualDeleteOne {
...
func (c *IndividualClient) Get(ctx context.Context, id int64) (*Individual, error) {
	return c.Query().Where(individual.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *IndividualClient) GetX(ctx context.Context, id int64) *Individual {
