...
import (
	...
	"github.com/example/micro/employment-order/internal/config"
	"github.com/example/micro/employment-order/internal/data"
	"github.com/example/micro/employment-order/internal/server"
	"github.com/example/micro/employment-order/internal/service"
)
