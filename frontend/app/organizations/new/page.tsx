    ...
    <div className="flex min-h-screen bg-linear-to-b from-zinc-950 via-zinc-950 to-zinc-900 p-8">
      <div className="w-full max-w-5xl space-y-8 mx-auto">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-3xl font-bold text-zinc-50">Создание организации</h1>
            <p className="text-zinc-400 mt-2 text-sm">Основные реквизиты: наименование, адрес, ОКПО и ИНН/КПП.</p>
          </div>
          <Link
            href="/organizations"
