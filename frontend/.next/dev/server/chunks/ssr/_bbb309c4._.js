...
"[project]/app/dismissal-orders/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DismissalOrdersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        Promise.all([
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGet"])("/api/dismissal-orders"),
...
<body>
  <div class="wrap">
    ...
    const handlePrint = async (row)=>{
        ...
        try {
            const [header, bodies, contracts, individuals, departments, positions] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGet"])(`/api/dismissal-orders/${row.id}`),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGet"])(`/api/dismissal-orders/bodies?header_id=${row.id}`),
    ...
    const handleDelete = async (row)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiDelete"])(`/api/dismissal-orders/${row.id}`);
        } catch (err) {
...
//# sourceMappingURL=_bbb309c4._.js.map