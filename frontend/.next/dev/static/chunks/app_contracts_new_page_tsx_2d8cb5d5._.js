...
"[project]/app/contracts/new/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const getBaseUrl = ()=>("TURBOPACK compile-time value", "http://localhost:8080") || "http://localhost:8080";
const defaultConditions = [
    {
        id: 1,
        label: "Обычные условия"
    },
    {
        id: 2,
        label: "Вредные условия"
    },
    {
        id: 3,
...
function ContractCreatePage() {
    ...
    const [representatives, setRepresentatives] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [conditions, setConditions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultConditions);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ContractCreatePage.useEffect": ()=>{
            const baseUrl = getBaseUrl();
            fetch(`${baseUrl}/api/organizations`).then({
                "ContractCreatePage.useEffect": (r)=>r.json()
            }["ContractCreatePage.useEffect"]).then({
                "ContractCreatePage.useEffect": (d)=>setOrganizations(d ?? [])
            }["ContractCreatePage.useEffect"]).catch({
                "ContractCreatePage.useEffect": ()=>setOrganizations([])
            }["ContractCreatePage.useEffect"]);
            fetch(`${baseUrl}/api/individuals`).then({
                "ContractCreatePage.useEffect": (r)=>r.json()
            }["ContractCreatePage.useEffect"]).then({
                "ContractCreatePage.useEffect": (d)=>{
                    const list = d ?? [];
                    // map to {id, name}
                    const mapped = list.map({
                        "ContractCreatePage.useEffect.mapped": (it)=>({
                                id: it.id,
                                name: [
                                    it.last_name,
                                    it.first_name,
                    ...
                    }["ContractCreatePage.useEffect.mapped"]);
                    setEmployees(mapped);
                    setRepresentatives(mapped.filter({
                        "ContractCreatePage.useEffect": (it)=>{
                            // find original by id to check is_authorized_representative
                            const orig = list.find({
                                "ContractCreatePage.useEffect.orig": (x)=>x.id === it.id
                            }["ContractCreatePage.useEffect.orig"]);
            ...
            fetch(`${baseUrl}/api/departments`).then({
                "ContractCreatePage.useEffect": (r)=>r.json()
            }["ContractCreatePage.useEffect"]).then({
                "ContractCreatePage.useEffect": (d)=>setDepartments(d ?? [])
            }["ContractCreatePage.useEffect"]).catch({
                "ContractCreatePage.useEffect": ()=>setDepartments([])
            }["ContractCreatePage.useEffect"]);
            fetch(`${baseUrl}/api/positions`).then({
                "ContractCreatePage.useEffect": (r)=>r.json()
            }["ContractCreatePage.useEffect"]).then({
                "ContractCreatePage.useEffect": (d)=>setPositions(d ?? [])
            }["ContractCreatePage.useEffect"]).catch({
                "ContractCreatePage.useEffect": ()=>setPositions([])
            }["ContractCreatePage.useEffect"]);
        }
    }["ContractCreatePage.useEffect"], []);
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    children: "Создание трудового договора"
                                }, void 0, false, {
                                    fileName: "[project]/app/contracts/new/page.tsx",
                                    lineNumber: 126,
                                    columnNumber: 13
                                }, this),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-zinc-400 mt-2 text-sm",
                                    children: "Заполните реквизиты договора, участников, условия работы и график. Поля можно скорректировать вручную."
                                }, void 0, false, {
                                    fileName: "[project]/app/contracts/new/page.tsx",
                                    lineNumber: 127,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                organizations.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: item.id,
                                                        children: item.title
                                                    }, item.id, false, {
                                                        fileName: "[project]/app/contracts/new/page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: "Представитель организации"
                                        }, void 0, false, {
                                            fileName: "[project]/app/contracts/new/page.tsx",
                                            lineNumber: 193,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: "",
                                                    disabled: true,
                                                    children: "Выберите представителя"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/contracts/new/page.tsx",
                                                    lineNumber: 199,
                                                    columnNumber: 17
                                                }, this),
                                                representatives.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: item.id,
                                                        children: item.name
                                                    }, item.id, false, {
                                                        fileName: "[project]/app/contracts/new/page.tsx",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                employees.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: item.id,
                                                        children: item.name
                                                    }, item.id, false, {
                                                        fileName: "[project]/app/contracts/new/page.tsx",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: "",
                                                    disabled: true,
                                                    children: "Выберите подразделение"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/contracts/new/page.tsx",
                                                    lineNumber: 239,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: "",
                                                    disabled: true,
                                                    children: "Выберите должность"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/contracts/new/page.tsx",
                                                    lineNumber: 256,
                                                    columnNumber: 17
                                                }, this),
                                                positions.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: item.id,
                                                        children: item.title
                                                    }, item.id, false, {
                                                        fileName: "[project]/app/contracts/new/page.tsx",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                conditions.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: item.id,
                                                        children: item.label
                                                    }, item.id, false, {
                                                        fileName: "[project]/app/contracts/new/page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: "Работа по (если срочный договор)"
                                        }, void 0, false, {
                                            fileName: "[project]/app/contracts/new/page.tsx",
                                            lineNumber: 303,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: "Испытательный срок (мес.)"
                                        }, void 0, false, {
                                            fileName: "[project]/app/contracts/new/page.tsx",
                                            lineNumber: 312,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: "Оплачиваемый отпуск (дн.)"
                                        }, void 0, false, {
                                            fileName: "[project]/app/contracts/new/page.tsx",
                                            lineNumber: 322,
                                            columnNumber: 15
...
_s(ContractCreatePage, "/Wi18jVDHpLJihRQmNwM8xt+HrE=");
_c = ContractCreatePage;
var _c;
__turbopack_context__.k.register(_c, "ContractCreatePage");
...
//# sourceMappingURL=app_contracts_new_page_tsx_2d8cb5d5._.js.map