...
function OrganizationCreatePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizationCreatePage.useEffect": ()=>{
            const baseUrl = ("TURBOPACK compile-time value", "http://localhost:8080") || "http://localhost:8080";
            fetch(`${baseUrl}/api/accounts`).then({
                "OrganizationCreatePage.useEffect": (res)=>res.json()
            }["OrganizationCreatePage.useEffect"]).then({
                "OrganizationCreatePage.useEffect": (data)=>setAccounts(data ?? [])
            }["OrganizationCreatePage.useEffect"]).catch({
                "OrganizationCreatePage.useEffect": ()=>setAccounts([])
            }["OrganizationCreatePage.useEffect"]);
        }
    }["OrganizationCreatePage.useEffect"], []);
    ...
    const handleSave = async ()=>{
        setSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])("/api/organizations", {
...
_s(OrganizationCreatePage, "z210DS+Q1is8pjN8dq5gHP9fCLk=", false, function() {
    return [
...
//# sourceMappingURL=_1deeaffd._.js.map