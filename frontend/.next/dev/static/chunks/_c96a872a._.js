...
function ContractEditPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ContractEditPage.useEffect": ()=>{
            ...
            // fetch contract
            if (!params?.id) return;
            fetch(`${baseUrl}/api/contracts/${params?.id}`).then({
                "ContractEditPage.useEffect": (r)=>r.json()
            }["ContractEditPage.useEffect"]).then({
                "ContractEditPage.useEffect": (data)=>{
                    if (!data) return;
                    setForm({
                        number: data.number ?? "",
            ...
            }["ContractEditPage.useEffect"]).catch({
                "ContractEditPage.useEffect": (err)=>console.error("Failed to load contract", err)
            }["ContractEditPage.useEffect"]);
            // load options
            fetch(`${baseUrl}/api/organizations`).then({
                "ContractEditPage.useEffect": (r)=>r.json()
            }["ContractEditPage.useEffect"]).then({
                "ContractEditPage.useEffect": (d)=>setOrganizations(d ?? [])
            }["ContractEditPage.useEffect"]).catch({
                "ContractEditPage.useEffect": ()=>setOrganizations([])
            }["ContractEditPage.useEffect"]);
            fetch(`${baseUrl}/api/individuals`).then({
                "ContractEditPage.useEffect": (r)=>r.json()
            }["ContractEditPage.useEffect"]).then({
                "ContractEditPage.useEffect": (d)=>{
                    const list = d ?? [];
                    const mapped = list.map({
                        "ContractEditPage.useEffect.mapped": (it)=>({
                                id: it.id,
                                name: [
                                    it.last_name,
                                    it.first_name,
                    ...
                    }["ContractEditPage.useEffect.mapped"]);
                    setEmployees(mapped);
                    setRepresentatives(mapped.filter({
                        "ContractEditPage.useEffect": (it)=>{
                            const orig = list.find({
                                "ContractEditPage.useEffect.orig": (x)=>x.id === it.id
                            }["ContractEditPage.useEffect.orig"]);
            ...
            fetch(`${baseUrl}/api/departments`).then({
                ...
                "ContractEditPage.useEffect": (d)=>setDepartments(d ?? [])
            }["ContractEditPage.useEffect"]).catch({
                "ContractEditPage.useEffect": ()=>setDepartments([])
            }["ContractEditPage.useEffect"]);
            fetch(`${baseUrl}/api/positions`).then({
                "ContractEditPage.useEffect": (r)=>r.json()
            }["ContractEditPage.useEffect"]).then({
                "ContractEditPage.useEffect": (d)=>setPositions(d ?? [])
            }["ContractEditPage.useEffect"]).catch({
                "ContractEditPage.useEffect": ()=>setPositions([])
            }["ContractEditPage.useEffect"]);
        }
    }["ContractEditPage.useEffect"], [
        params?.id
    ...
    const handleSave = async ()=>{
        ...
        setSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPatch"])(`/api/contracts/${params?.id}`, payload);
...
_s(ContractEditPage, "/jyHn52DuG/h8PbY0bqXim5jWhs=", false, function() {
    return [
...
//# sourceMappingURL=_c96a872a._.js.map