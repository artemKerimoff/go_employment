...
function AccountsPage() {
    _s();
    const [rows, setRows] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // Start empty
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccountsPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/api/accounts").then({
                "AccountsPage.useEffect": (data)=>setRows(data ?? [])
            }["AccountsPage.useEffect"]) // Use server data only
            .catch({
                "AccountsPage.useEffect": (err)=>{
    ...
    const handleDelete = async (row)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiDelete"])(`/api/accounts/${row.id}`);
        } catch (err) {
...
_s(AccountsPage, "aEmP4ME4qF+uYWoxBpsZBPdGgb8=");
_c = AccountsPage;
var _c;
...
//# sourceMappingURL=_753d909a._.js.map