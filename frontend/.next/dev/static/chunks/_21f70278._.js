...
"[project]/app/individuals/[id]/edit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function IndividualEditPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IndividualEditPage.useEffect": ()=>{
            if (!params?.id) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/api/individuals/${params.id}`).then({
                "IndividualEditPage.useEffect": (data)=>{
                    if (!data) {
                        setForm({
                            lastName: "",
                            firstName: "",
            ...
            }["IndividualEditPage.useEffect"]).catch({
                "IndividualEditPage.useEffect": (err)=>console.error("Failed to load individual", err)
            }["IndividualEditPage.useEffect"]).finally({
                "IndividualEditPage.useEffect": ()=>setLoading(false)
            }["IndividualEditPage.useEffect"]);
        }
    }["IndividualEditPage.useEffect"], [
        params?.id
    ...
    const handleSave = async ()=>{
        ...
        setSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPatch"])(`/api/individuals/${params.id}`, {
...
_s(IndividualEditPage, "teNidU0GeqkGWLXi//x5LIpL9aU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = IndividualEditPage;
var _c;
__turbopack_context__.k.register(_c, "IndividualEditPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_21f70278._.js.map