...
function OrganizationsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizationsPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/api/organizations").then({
                "OrganizationsPage.useEffect": (data)=>setRows(data ?? [])
            }["OrganizationsPage.useEffect"]).catch({
                "OrganizationsPage.useEffect": (err)=>{
    ...
    const handleDelete = async (row)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiDelete"])(`/api/organizations/${row.id}`);
        } catch (err) {
...
_s(OrganizationsPage, "aEmP4ME4qF+uYWoxBpsZBPdGgb8=");
...
//# sourceMappingURL=_d1365f72._.js.map