...
"[project]/app/employment-orders/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EmploymentOrdersPage() {
    ...
    const [printRow, setPrintRow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EmploymentOrdersPage.useEffect": ()=>{
            // Load orders and organizations to show readable organization titles
            Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/api/employment-orders"),
                ...
                "EmploymentOrdersPage.useEffect": ([orders, orgsData])=>{
                    const orgMap = new Map();
                    (orgsData ?? []).forEach({
                        "EmploymentOrdersPage.useEffect": (o)=>orgMap.set(o.id, o)
                    }["EmploymentOrdersPage.useEffect"]);
                    setOrgs(orgsData ?? []);
                    const mapped = (orders ?? []).map({
                        "EmploymentOrdersPage.useEffect.mapped": (o)=>({
                                id: o.id,
                                number: o.number ?? "",
                    ...
                    }["EmploymentOrdersPage.useEffect.mapped"]);
                    setRows(mapped);
                }
            }["EmploymentOrdersPage.useEffect"]).catch({
                "EmploymentOrdersPage.useEffect": (err)=>{
...
<body>
  <div class="wrap">
    ...
    const handlePrint = async (row)=>{
        ...
        try {
            const [header, bodies, contracts, individuals, departments, positions] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/api/employment-orders/${row.id}`),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/api/employment-orders/bodies?header_id=${row.id}`),
    ...
    const handleDelete = async (row)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiDelete"])(`/api/employment-orders/${row.id}`);
        } catch (err) {
...
_s(EmploymentOrdersPage, "ix2HmTRBVgzXNxNYbL5QgTLIyNg=");
_c = EmploymentOrdersPage;
var _c;
__turbopack_context__.k.register(_c, "EmploymentOrdersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_9db2b1b6._.js.map